  ...
  return (
    <div className="parent-elemeent w-full h-fit relative flex flex-col text-white">
      ...
      <div className="py-[40px] bg-[#202020] relative">
        <img src={manusiaPanduan} alt="" className="absolute scale-55 right-[-55px] bottom-[-30px]" />

        <div ref={hPanduan} className={`w-fit block mx-auto duration-[2s] ease-out ${viewHPanduan ? "opacity-100" : "opacity-0"}`} >
          <h1 className={`font-poppins text-[2.5rem] text-center md:leading-[60px] leading-[40px] !text-white`}>
            Panduan
          </h1>
        </div>
